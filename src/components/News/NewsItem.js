...
const MovieNewsItem = props => {
  return (
    ...
    <div className="row">
      ...
      <img src={props.frontImg} style={{ padding: "20px" }} className="img-fluid w-100" alt="contains cover News "/>      </div>
      <div className="col-md-8 " style={{ padding: "15px" }}>       <h4>{props.heading}</h4>
       <p>{props.date}</p>
